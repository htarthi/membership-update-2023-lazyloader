...
use App\Jobs\AfterAuthenticationJob;
...
return [
    ...
    */
    ...
    'webhooks' => [
            ...
            [
                'topic' => 'CUSTOMER_PAYMENT_METHODS_CREATE',
                'address' => env('Webhook_URL')
            ],
            [
                'topic' => 'CUSTOMER_PAYMENT_METHODS_REVOKE',
                'address' => env('Webhook_URL')
            ],
            [
                'topic' => 'CUSTOMER_PAYMENT_METHODS_UPDATE',
                'address' => env('Webhook_URL')
            ],
            [
    ...
    */
    ...
    'scripttags' => [
        [
            'src' => env('SHOPIFY_CHECKOUT_SCRIPTTAG_SRC'),
    ...
    */
    ...
    'after_authenticate_job' => [
        [
            'job' => AfterAuthenticationJob::class,
