    ...
    <style>
        * {
        ...
        button.marketing-button:focus {
            box-shadow: 0 0 0.1875em 0.1875em #cecbcb;
            background-color: #000000;
            color: #fff;
        }
    </style>
...
<main class="container" role="main">
    <h3 class="title">
        Simplee Memberships - Install :: Simplee Apps
    </h3>
    <h3 class="title logo">
        <img src="/images/static/simplee-logo-300.png" />
    </h3>
    ...
    <p class="subhead">
        <label for="shop">Enter your myshopify.com domain to install or login</label>
    </p>
