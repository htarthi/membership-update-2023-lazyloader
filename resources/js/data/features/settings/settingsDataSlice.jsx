...
const initialState = {
    ...
    isChangeData : false,
    defaultOpen : 0, //hitarthi
    initialSettingData:null,//hitarthi
    errors: []
};
...
export const settingsDataSlice = createSlice({
    ...
    extraReducers: {
        ...
        [getSettingsData.fulfilled]: (state, { payload }) => {
            ...
            state.initialSettingData = payload?.data?.data; //hitarthi
        },
        ...
        [setSettingsData.fulfilled]: (state, { payload }) => {
            ...
            state.isChangeData = false;
            state.initialSettingData = state.data.data ; //hitarthi
    ...
    reducers: {
        ...
        //hitarthi
        setdefaultOpen : (state, action) => {
            state.defaultOpen = action.payload;
            console.log("slice",state.defaultOpen);
        },

        resetdefaultOpen: (state) => {
            state.defaultOpen = 0;
        },

        discardChanges: (state) => {
                state.data.data = state.initialSettingData;
                state.isChangeData = false;
        },

        // discardChanges:(state, action)=>{
        //     if(state.initialSettingData)
        //     {
        //         state.data.data.setting = state.initialSettingData;
        //         state.isChangeData = false;
        //     }else{
        //     // state.data.data.setting = state.initialSettingData;
        //     // state.isChangeData = false;
...
export const { updateMainData, settingReducer, updateSetting, updatePortal, updateEmailTemplate, updateTransalationsdata, updateEditCodeData, resetisSuccess , setChanged,setdefaultOpen,resetdefaultOpen,discardChanges } = settingsDataSlice.actions;
