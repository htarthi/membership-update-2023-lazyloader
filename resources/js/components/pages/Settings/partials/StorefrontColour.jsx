...
export default function StorefrontColour() {
  ...
  return (
    <>
        {/* colors fields */}
        {/* <Text variant="bodyLg" as="h6" fontWeight="regular" >If using the legacy widget (not the app embed), which colors should the widget show?</Text> */}
        ...
        {/* <div className="sent_notification_input_field ms-margin-top">
            <TextField
