...
class CreateSsRulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ss_rules', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('rule_attribute1')->nullable();
            $table->string('rule_attribute2')->nullable();
            $table->timestamps();
