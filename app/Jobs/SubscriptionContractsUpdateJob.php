...
class SubscriptionContractsUpdateJob implements ShouldQueue
{
    ...
    {
        try{
            logger('============== START:: Subscription Contracts Update Webhook ===========');
            ...
            $webhookId = $this->webhook('subscription_contracts/update', $user->id, json_encode($this->data));
