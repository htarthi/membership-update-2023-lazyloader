...
class SubscriptionBillingAttemptsSuccessJob implements ShouldQueue
{
    ...
    {
        try{
            logger('============== START:: Subscription Billing Attempts Success Webhook ===========');
            ...
            $webhookId = $this->webhook('subscription_billing_attempts/success', $user->id, json_encode($this->data));
