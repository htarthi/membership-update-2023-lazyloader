...
class RecurringNotifyAdvanceMailGun extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'recurring:notifyAdvanceMailGun';
     ...
     * @var string
     */
    protected $description = 'Email Notification - notify customers when they have a recurring payment coming up for advance mail gun configuration';
    ...
    {
        try {
            logger("============= START:: RecurringNotify Advance Mail Gun ============");
            ...
            logger("============= END:: RecurringNotify Advance Mail Gun ============");
        } catch (\Exception $e) {
            logger("============== ERROR:: RecurringNotify Advance Mail Gun ===========");
            logger($e);
        }
        return 0;
    }
